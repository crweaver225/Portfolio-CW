...
### Conclusion
I have a soft spot in my heart for C++. I probably always will. C++ has powered so much of the technological revolution of the past 40 years and will likely continue to play a pivotal role well into the future. C++ will continue to be my primary driver for the foreseeable future. But the challenges with the language are here to stay with us going forward. It is up to us who will continue to maintain the billions of lines of C++ code that help run our modern world to leverage C++ to the best of our abilities. Part of this comes from learning from other languages. Much of what Rust does can be done in C++ (although not with the same degree of compiler checking). We can learn lessons from Rust and integrate them into our code in a ways that will improve our software. C++ has its cracks, but we live in a world of economic and technical compromise. C++ is not going away, lets take lessons from Rust and make our language better. 
